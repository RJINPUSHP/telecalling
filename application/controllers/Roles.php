...
class Roles extends BaseController
{
    ...
    function roleListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Political Calling : Roles Listing';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'Political Calling : Add New Role';
    ...
    function edit($roleId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'Political Calling : Edit Role';
